...
class CrmController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        // dd($crmLast);
        return view('crms.create', get_defined_vars(),['customer' => $single_customer]);
    }
    ...
    public function download(Request $request)
    {
        ...
        return Excel::download($export, 'crms'.'-'.$request->start_date.' to '.$request->end_date.'.xlsx');
