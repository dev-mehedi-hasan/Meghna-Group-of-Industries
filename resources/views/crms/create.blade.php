                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="alternate_number" name="alternate_number" value="<?php if(isset($crmLast->alternate_number))echo $crmLast->alternate_number; ?>" placeholder="Alternate Customer Number">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input disabled type="text" class="form-control" id="wing_name" name="wing_name" value="{{ $single_customer->wing_name??'' }}" placeholder="Wing Name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="dealer_division" class="col-sm-3 col-form-label ">Division</label>
                            <div class="col-sm-9">
                                <input disabled type="text" class="form-control" id="dealer_division" name="dealer_division" value="{{ $single_customer->division_name??'' }}" placeholder="Dealer/Distributor Division">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="area" class="col-sm-3 col-form-label ">Area</label>
                            <div class="col-sm-9">
                                <input disabled type="text" class="form-control" id="area" name="area" value="{{ $single_customer->area_name??'' }}" placeholder="Area">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="territory" class="col-sm-3 col-form-label ">Territory</label>
                            <div class="col-sm-9">
                                <input disabled type="text" class="form-control" id="territory" name="territory" value="{{ $single_customer->territory_name??'' }}" placeholder="Territory">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="region" class="col-sm-3 col-form-label ">Region</label>
                            <div disabled class="col-sm-9">
                                <input disabled type="text" class="form-control" id="region" name="region" value="{{ $single_customer->region_name??'' }}" placeholder="Region">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="designation" class="col-sm-3 col-form-label ">Designation</label>
                            <div class="col-sm-9">
                                <input disabled type="text" class="form-control" id="designation" name="designation" value="{{ $single_customer->designation??'' }}" placeholder="Designation">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input disabled type="text" class="form-control" id="distributor_name" name="distributor_name" value="{{ $single_customer->distributor_name??'' }}" placeholder="Distributor Name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="proprietor_name" class="col-sm-3 col-form-label ">Proprietor Name</label>
                            <div class="col-sm-9">
                                <input disabled type="text" class="form-control" id="proprietor_name" name="proprietor_name" value="{{ $single_customer->proprietor_name??'' }}" placeholder="Proprietor Name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="verification_code" class="col-sm-3 col-form-label ">Verification Code</label>
                            <div class="col-sm-9">
                                <input disabled type="text" class="form-control" id="verification_code" name="verification_code" value="{{ $single_customer->verification_code??'' }}" placeholder="Verification Code">
                            </div>
                        </div>
                        <div class="form-group row">
